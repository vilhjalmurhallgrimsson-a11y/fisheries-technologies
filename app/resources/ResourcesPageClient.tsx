    ...
    <section className="py-20 lg:py-24">
      <div className="mx-auto max-w-3xl px-6 text-center">
        ...
        <p className="mt-6 text-lg leading-8 text-slate-600">
          Explore our current white paper and governance framework, developed
          to support fisheries authorities, regional organisations and
    ...
    <section className="pb-24 lg:pb-32">
      <div className="mx-auto grid max-w-7xl gap-8 px-6 lg:grid-cols-2 lg:px-10">
        {resources.map((resource) => (
          <ResourceCard key={resource.analyticsId} resource={resource} />
        ))}
      </div>
    </section>
  );
    ...
    <section className="bg-slate-50 py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-600">
            Our publications connect practical implementation experience with
            broader questions of institutional capability, data use and
